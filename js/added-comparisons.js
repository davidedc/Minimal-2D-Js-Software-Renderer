...
function add2PxHorizontalLineCenteredAtGridComparison() {
  let comparisonLog = [];
  return new RenderComparison(
    'centered-2px-horizontal-line',
    "Single 2px Horizontal Line centered at grid",
    (shapes) => {
      const extremes = add2PxHorizontalLineCenteredAtGrid(shapes, comparisonLog);
      return extremes;
    },
    (comparison) => {
      const extremes = comparison.builderReturnValue;
    ...
    'Tests crisp rendering of a 2px horizontal line centered at grid'
  );
}