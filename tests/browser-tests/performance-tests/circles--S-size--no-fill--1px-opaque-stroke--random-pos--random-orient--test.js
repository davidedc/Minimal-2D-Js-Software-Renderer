// Circles with small size, no fill and 1px opaque stroke, random positioning and orientation
function draw_circles__S_size__no_fill__1px_opaque_stroke__random_pos__random_orient(ctx, count) {
